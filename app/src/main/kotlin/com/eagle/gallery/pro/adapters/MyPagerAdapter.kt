...
import com.eagle.gallery.pro.activities.ViewPagerActivity
...
class MyPagerAdapter(val activity: com.eagle.gallery.pro.activities.ViewPagerActivity, fm: FragmentManager, val media: MutableList<Medium>) : FragmentStatePagerAdapter(fm) {
